-- 我的b站UID:1531514159看不懂注释的可以看我视频（删了这个注释死全家😈）
local MD5_CONSTANTS = {
...
-- 他们需要使用注入器运行以下脚本：
--[[
    local access_code = "在这里填写你生成的密钥（执行私服脚本后会自动生成一个密钥到粘贴板）"
    local place_id = game.PlaceId
    game.RobloxReplicatedStorage.ContactListIrisInviteTeleport:FireServer(place_id, "", access_code)
]]